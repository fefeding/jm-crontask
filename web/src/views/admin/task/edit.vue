        ...
        <el-form ref="form" v-model="taskData" label-width="80px">
            ...
            <el-form-item label="执行方式">
                ...
                <el-col :span="15">
                    ...
                    <div v-else-if="taskData.timeSize == 7" style="display:flex">
                        <el-popover v-model="cronPopover">
                            <cron @change="changeCron" @close="cronPopover=false" :data="timeValue"></cron>
                            <el-input slot="reference" @click="cronPopover=true" v-model="timeValue" placeholder="请输入定时策略"></el-input>
                        </el-popover>
                        <span>(秒 分 时 日 月 周 年)</span>
                        <span style="color:red;margin-left:6px">整时整分需要将前面的秒或者分设为0</span>
                    </div>
